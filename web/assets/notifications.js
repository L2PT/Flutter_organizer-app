! function(t) {
        ...
        function e(t) {
            return t = n(t),
                function() {
                    ...
                    if ((0, o.append)(a, (0, o.createSpan)("material-icons")("")),(0, o.isString)(e) && e.length && (0, o.append)(a, (0, o.createParagraph)("ncf-title")(e)), (0, o.isString)(i) && i.length && (0, o.append)(a, (0, o.createParagraph)("nfc-message")(i)), (0, o.append)(c, a), t.showDuration && t.showDuration > 0) {
    ...
    n.createSpan = function() {
        for (var t = arguments.length, n = Array(t), e = 0; e < t; e++) n[e] = arguments[e];
        return c.apply(void 0, ["span"].concat(n))
    }
}, function(t, n) {}]);