        ...
        var s = r(1),
            ...
            c = function(e) {
                ...
                return s.__extends(t, e), t.prototype.computeDisplayEventTime = function() {
                    ...
                    return '<a class="' + s.join(" ") + '"><span class="fc-event-prefix" style="' + a.cssToStr(this.getSkinCss(e.footprint.eventDef)) + '"></span><div class="fc-content">' + (l ? '<span class="fc-time">' + a.htmlEscape(l) + "</span>" : "") + '<span class="fc-title">' + (r.title ? a.htmlEscape(r.title) : "&nbsp;") + '</span></div><div class="fc-content"><span class="fc-subtitle" style="color:'+e.footprint.eventDef.color+'">' + (r.url ? a.htmlEscape(r.url) : "&nbsp;") + '</span></div><div class="fc-bg" />' + (n ? '<div class="fc-resizer fc-start-resizer"></div>' : "") + (i ? '<div class="fc-resizer fc-end-resizer"></div>' : "") + "</a>"
                }, t
            }(a.EventRenderer);
        t["default"] = c
    }, function(e, t, r) {
            ...
            d = function() {
                ...
                return e.prototype.renderSkeleton = function() {
                    ...
                    for (var l = 0; l < t.length; l++) {
                        var a = t[l],
                            c = l === t.length - 1;
                        r += '<th class="' + e.getClass("widgetHeader") + '"><div><div class="fc-cell-content l2pt-textOperatori">' + (a.isMain ? '<span class="fc-expander-space"><span class="fc-icon"></span></span>' : "") + '<span class="fc-cell-text">' + n.htmlEscape(a.labelText || "") + '</span><span class="fc-resource-header-postfix"><span class="fa fa-plus"></span></div>' + (c ? "" : '<div class="fc-col-resizer"></div>') + "</div></th>"
                    }
                        ...
                        if (!a.group) {
                            if(r.Responsabile){
                                var l = a.field ? r[a.field] || null : r,
                                    ...
                                    u = n('<div class="fc-cell-content" data-id="'+r.id+'"><span class="fc-resource-prefix"><svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="user-tie" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" class="svg-inline--fa fa-user-tie fa-w-16"><path fill="currentColor" d="M224 256c70.7 0 128-57.3 128-128S294.7 0 224 0 96 57.3 96 128s57.3 128 128 128zm95.8 32.6L272 480l-32-136 32-56h-96l32 56-32 136-47.8-191.4C56.9 292 0 350.3 0 422.4V464c0 26.5 21.5 48 48 48h352c26.5 0 48-21.5 48-48v-41.6c0-72.1-56.9-130.4-128.2-133.8z" class=""></path></svg></span>' + (a.isMain ? this.renderGutterHtml() : "") + '<span class="fc-cell-text"><span class="fc-cell-text surname">' + (c ? i.htmlEscape(c).split(" ")[0] : "&nbsp;") + '<span class="fc-cell-text name"> ' + (c ? i.htmlEscape(c).split(" ")[1]?i.htmlEscape(c).split(" ")[1] : "&nbsp;" : "&nbsp;") + '</span></span></span><span class="fc-resource-postfix"><span class="fa fa-trash"></span></span></div>"');
                            }else{
                                var l = a.field ? r[a.field] || null : r,
                                    c = "function" == typeof a.text ? a.text(r, l) : l,
                                    u = n('<div class="fc-cell-content" data-id="'+r.id+'"><span class="fc-resource-prefix"><svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="hard-hat" class="svg-inline--fa fa-hard-hat fa-w-16" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path fill="currentColor" d="M480 288c0-80.25-49.28-148.92-119.19-177.62L320 192V80a16 16 0 0 0-16-16h-96a16 16 0 0 0-16 16v112l-40.81-81.62C81.28 139.08 32 207.75 32 288v64h448zm16 96H16a16 16 0 0 0-16 16v32a16 16 0 0 0 16 16h480a16 16 0 0 0 16-16v-32a16 16 0 0 0-16-16z"></path></svg></span>' + (a.isMain ? this.renderGutterHtml() : "") + '<span class="fc-cell-text"><span class="fc-cell-text surname">' + (c ? i.htmlEscape(c).split(" ")[0] : "&nbsp;") + '<span class="fc-cell-text name"> ' + (c ? i.htmlEscape(c).split(" ")[1]?i.htmlEscape(c).split(" ")[1] : "&nbsp;" : "&nbsp;") + '</span></span></span><span class="fc-resource-postfix"><span class="fa fa-trash"></span></span></div>"');
                            }
                            "function" == typeof a.render && (u = a.render(r, u, l) || u);
                            var d = n('<td class=" divElementOperator ' + t.getClass("widgetContent") + '"/>').append(u);
