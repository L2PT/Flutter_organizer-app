                    ...
                    for (var t = this.view.calendar.theme, r = this.resource, o = 0, s = this.view.colSpecs; o < s.length; o++) {
                        ...
                        if (!a.group) {
                            var l = a.field ? r[a.field] || null : r,
                                ...
                                u = n('<div class="fc-cell-content" data-id="'+r.id+'"><span class="fc-resource-prefix"><svg viewBox="0 0 24 24"><path d="M0 0h24v24H0z" fill="none"/><path d="M20 6h-4V4c0-1.11-.89-2-2-2h-4c-1.11 0-2 .89-2 2v2H4c-1.11 0-1.99.89-1.99 2L2 19c0 1.11.89 2 2 2h16c1.11 0 2-.89 2-2V8c0-1.11-.89-2-2-2zm-6 0h-4V4h4v2z" fill="currentColor"/></svg></span>' + (a.isMain ? this.renderGutterHtml() : "") + '<span class="fc-cell-text"><span class="fc-cell-text surname">' + (c ? i.htmlEscape(c).split(" ")[0] : "&nbsp;") + '<span class="fc-cell-text name"> ' + (c ? i.htmlEscape(c).split(" ")[1]?i.htmlEscape(c).split(" ")[1] : "&nbsp;" : "&nbsp;") + '</span></span></span><span class="fc-resource-postfix"><span class="fa fa-trash"></span></span></div>"');
