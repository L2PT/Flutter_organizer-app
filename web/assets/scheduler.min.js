            ...
            d = function() {
                ...
                return e.prototype.renderSkeleton = function() {
                    ...
                    for (var l = 0; l < t.length; l++) {
                        var a = t[l],
                            c = l === t.length - 1;
                        r += '<th class="' + e.getClass("widgetHeader") + '"><div><div class="fc-cell-content">' + (a.isMain ? '<span class="fc-expander-space"><span class="fc-icon"></span></span>' : "") + '<span class="fc-cell-text">' + n.htmlEscape(a.labelText || "") + '</span><span class="fc-resource-header-postfix"><span class="fa fa-plus"></span></div>' + (c ? "" : '<div class="fc-col-resizer"></div>') + "</div></th>"
                    }
