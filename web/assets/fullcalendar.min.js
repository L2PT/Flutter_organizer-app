        ...
        var i = n(3),
            ...
            o = function() {
                ...
                return t.prototype.opt = function(t) {
                    ...
                    var status;
                    switch (t.footprint.eventDef.miscProps.Stato) {
                      case -2: status = "deleted-event"; break;
                      case -1: status = "refused-event"; break;
                      case 0: status = "new-event"; break;
                      case 1: status = "delivered-event"; break;
                      case 2: status = "seen-event"; break;
                      case 3: status = "accepted-event"; break;
                      case 4: status = "ended-event"; break;
                      default: status = "";
                    }
                    i.push(status)
