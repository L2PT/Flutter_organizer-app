          ...
          title: new Text(
              widget.isSupervisor
                  ...
                  : _menuOperatore[widget.frontLayerRoute]
                      ...
                      .toUpperCase(),
              style: title_rev),
          //TODO decidere se volete il nome della pagina fisso o che cambia se hai il menu aperto
          elevation: 0.0,
  ...
  Widget router() {
    ...
    switch (route) {
      ...
      case global.Constants.dailyCalendarRoute:
        {
          return DailyCalendar(day: arguments);
        }
        break;
      ...
      case global.Constants.detailsEventViewRoute:
        {
          return arguments != null ? DetailsEvent(event: arguments) : null;
        }
        break;
