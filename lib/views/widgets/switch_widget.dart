...
class _CheckboxState extends State<CheckboxTriState> with TickerProviderStateMixin {
  @override
  Widget build(BuildContext context) {
    ...
    return _CheckboxRenderObjectWidget(
      ...
      superColor: widget.superColor ?? themeData.toggleableActiveColor,
