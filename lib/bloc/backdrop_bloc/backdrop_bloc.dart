...
//  String route;
//
//  BackdropBloc(this.user, this.isSupervisor):super(NotReady());
//
//  @override
...
//  /// the subscription: the snapshot STILL TO BE EXECUTED to retrieve the data for the chosen page
//  ///   *Input* an event with the route and the argument for that route
